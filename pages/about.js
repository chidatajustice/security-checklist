...
import Page, { SectionHeading, Heading, Subheading, Section } from '../components/Page';
  ...
  return (
    <Page showEmailCapture={false} displayProgress={false}>
      <SectionHeading>
        ...
        <Section>
          Bring together black technologists and community members in Chicago to learn together about data and justice.
          Empower each other to apply our skills.
        </Section>
      </SectionHeading>
    </Page>
  );
